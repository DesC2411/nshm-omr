...
- Xuất CSV chi tiết hoặc bảng `0/1` theo từng ý.
...
- **Xuất chi tiết**: SBD, mã đề, điểm, đáp án từng phần và lý do cần kiểm tra.
- **Xuất 0/1**: mỗi bài là một dòng; đúng là `1`, sai hoặc bỏ trống là `0`.
